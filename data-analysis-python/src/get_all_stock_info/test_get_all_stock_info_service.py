# data-analysis-python\src\get_all_stock_info\test_get_all_stock_info_service.py
import unittest
import pandas as pd
import os
from get_all_stock_info_service import get_all_stock_info

class TestGetAllStockInfoService(unittest.TestCase):
    def test_get_all_stock_info(self):
        ...
        # CSVファイルとして保存
        output_file = os.path.join(output_dir, "all_stock_info.csv")
...
# 本ファイル単体テスト
# python -m unittest discover -s src/get_all_stock_info -p 'test_get_all_stock_info_service.py'
