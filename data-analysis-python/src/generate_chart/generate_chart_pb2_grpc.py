...
def add_GenerateChartServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GenerateChart': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=generate__chart__pb2.GenerateChartRequest.FromString,
                    response_serializer=generate__chart__pb2.GenerateChartResponse.SerializeToString,
            ),
    }
